...
$$
V(x(t),t) = x(t)^\top P \, x(t), \quad P \succ 0.
$$
When substituted into the [Hamilton-Jacobi-Bellman Equation](HJB.md) along with the system's dynamics we attain
$$
0 = \min_{u(t)} \left\{x(t)^\top Q \, x(t) + u(t)^\top R \, u(t) + 2 \, x(t)^\top P \left(A \, x(t) + B \, u(t)\right) \right\}. \tag{1}
$$
...
$$
0 = Q - P B^\top R^{-1} B P + P A + A^\top P, \quad P \succ 0.
$$
