...
$$
x_k^\top P_k \, x_k = \min_{u_k} \left\{x_k^\top Q_k \, x_k + u_k^\top R_k \, u_k + (A_k x_k + B_k u_k)^\top P_{k+1} (A_k x_k + B_k u_k)\right\} \tag{1}.
$$
...
$$
u_k^* = - \left(R_k + B_k^\top P_{k+1} B_k\right)^{-1} B_k^\top P_{k+1} A_k \, x_k.
$$
