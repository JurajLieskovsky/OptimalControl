...
$$
x_k^\top P_k \, x_k = \min_{u_k} \left\{x_k^\top Q \, x_k + u_k^\top R \, u_k + (A_k x_k + B_k u_k)^\top P_{k+1} (A_k x_k + B_k u_k)\right\} \tag{1}.
$$
...
$$
u_k^* = - \left(R + B_k^\top P_{k+1} B_k\right)^{-1} B_k^\top P_{k+1} A_k \, x_k.
$$
...
$$
P_k = Q + A_k^\top P_{k+1} A_k - A_k^\top P_{k+1} B_k \left(B_k^\top P_{k+1} B_k + R\right)^{-1} B_k^\top P_{k+1} A_k, \quad P_N = Q_N
$$
