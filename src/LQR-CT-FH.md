...
$$
J(x(t_0),u(\tau),t_0) = \underbrace{x(t_f)^\top Q_f \, x(t_f)}_{\Phi(x_N)} + \int_{t_0}^{t_f} \underbrace{x(\tau)^\top Q(t) \, x(\tau) + u(\tau)^\top R(t) \, u(\tau)}_{l(x(\tau), u(\tau), \tau)} \, d\tau,
$$
...
\begin{gathered}
-x(t)^\top\! \dot{P}(t)\, x(t) = \\
\min_{u(t)} \left\{x(t)^\top Q(t) \, x(t) + u(t)^\top R(t) \, u(t) + 2 \, x(t)^\top P(t) \left(A(t) \, x(t) + B(t) \, u(t) \right) \right\}. \tag{1}
\end{gathered}
$$
...
$$
-\dot{P}(t) = Q(t) - P(t) \, B(t)^\top R(t)^{-1} B(t) \, P(t) + P(t) \, A(t) + A(t)^\top \! P(t) 
$$
